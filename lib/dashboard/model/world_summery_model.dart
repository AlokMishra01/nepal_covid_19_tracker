class WorldSummeryModel {
  ...
  WorldSummeryModel.fromJson(Map<String, dynamic> json) {
    ...
    activePerOneMillion = double.parse(json['activePerOneMillion'].toString());
    recoveredPerOneMillion = double.parse(json['recoveredPerOneMillion'].toString());
    criticalPerOneMillion = double.parse(json['criticalPerOneMillion'].toString());
